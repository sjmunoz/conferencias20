...
namespace MvcMovie.Controllers
{
    public class DinnersController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["ConferenceId"] = new SelectList(_context.Conference, "Id", "Name", dinner.ConferenceId);
            ViewData["RoomID"] = new SelectList(_context.Room, "Id", "Location", dinner.RoomID);
            return View(dinner);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Location,Menu,Id,RoomID,ConferenceId,PersonId,EventDate,EndEventDate,Track,UserId")] Dinner dinner)
        {
            if (id != dinner.Id)
            {
                return NotFound();
